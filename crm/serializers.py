...
class LeadSerializer(TenantMixin):
    ...
    class Meta:
        ...
        fields = [
            ...
            'source', 'owner_user_id', 'last_contacted_at', 'next_follow_up_at',
            'notes', 'address_line1', 'address_line2', 'city', 'state',
            'country', 'postal_code', 'created_at', 'updated_at', 'activities'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
...
class LeadListSerializer(TenantMixin):
    ...
    class Meta:
        ...
        fields = [
            ...
            'owner_user_id', 'next_follow_up_at', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']